...
public class ListaEsperaSocioView {
    ...
    public void setModoListaEspera(boolean esListaEspera) {
        if (esListaEspera) {
            btnInscribirse.setText("Unirse a Lista de Espera");
            btnInscribirse.setBackground(new Color(243, 156, 18)); 
        } else {
            btnInscribirse.setText("Inscribirse");
            btnInscribirse.setBackground(COLOR_EXITO); 
        }
    }
}